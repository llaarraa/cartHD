#' CART for binary outcomes using boosting with internal cross-validation and predicts the cross-validated class membership 
...
######################### beginning of the cross-validation step ##########################
...
y.pred=lapply(my.folds.cv, .cart.for.cv.boosting.internal.with.arguments, N, my.ranks, num.var, my.tr.s, my.y.s, my.w.s, my.y.0, my.data.train,  my.weights, y, min.samples, max.depth, min.gain, my.ind.s, num.boost, verbose, my.env)
