...
my.scores=matrix(unlist(lapply(my.folds, .cart.for.ee.cv.internal.with.arguments, N, num.var, my.tr.s, my.y.s, my.w.s, my.y.0, my.data.train,  my.weights, y, min.samples, max.depth, min.gain, my.ranks, y.test, num.samples.test, num.boost, my.data.test, my.ind.s, nfolds.Icv)), ncol=num.samples.test, byrow=T)
